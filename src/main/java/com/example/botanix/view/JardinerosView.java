...
public class JardinerosView
{
    ...
    {
        model.addAttribute("jardinero", new Jardineros());
        return "jardineros/form";
    }

    @PostMapping("/view/jardineros/save")
    public String save(@ModelAttribute Jardineros jardinero, RedirectAttributes ra)
    {
        jardinerosRepository.save(jardinero);
        ra.addFlashAttribute("success", "Jardinero guardado con éxito");
    ...
    {
        Jardineros jardinero = jardinerosRepository.findById(id).orElse(null);
    ...
    public String delete(@PathVariable Long id, RedirectAttributes ra)
    {
        ...
        ra.addFlashAttribute("success", "Jardinero eliminado con éxito");
        return "redirect:/view/jardineros";
    }
